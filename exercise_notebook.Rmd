...
```{r Generate an object that contains the library-size normalized log-CPM}
aveLogCPM_normByLibSize <- aveLogCPM(y, normalized.lib.sizes = TRUE)
save(aveLogCPM_normByLibSize, file = "aveLogCPM_normByLibSize.rda")
```
